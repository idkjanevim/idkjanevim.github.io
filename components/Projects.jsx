                        ...
                        >
                            <div className="card mx-5 border my-5 my-md-0">
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="card-text">
                                        Small website about Nasa and Space.{' '}
                                        <br /> This was my first project with
                                        Nextjs <br /> and for same reason a
                                        wanted to do <br /> something with API
                                    </p>
                            ...
                            <div className="card mx-5 border my-5 my-md-0">
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="card-text">
                                        My portfolio (this website). <br /> I
                                        wanted a way to showcase my work so I
                                        built this
                                    </p>
                            ...
                            <div className="card mx-5 border my-5 my-md-0">
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="card-text text-wrap">
                                        Pong clone made with Rust. <br /> This
                                        was my first real atempt of making
                                        something <br /> with Rust, I thougt
                                        that making simple game could <br /> be
                                        good way to learn
                                    </p>
                                    <div className="d-flex justify-content-between">
                                        <a
